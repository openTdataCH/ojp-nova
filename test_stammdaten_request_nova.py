...
def get_nova_client():
    ...
    location = NOVA_BASE_URL + NOVA_VERTRIEBSSTAMMDATEN_PATH
    client = Client.from_service(VertriebsstammdatenServicePortTypeSoapv14GetStammdatenFile, location=location, encoding="utf-8")
