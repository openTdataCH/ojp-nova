...
from ojp.expected_departure_capacities import ExpectedDepartureCapacities
from ojp.expected_departure_occupancy import ExpectedDepartureOccupancy
from ojp.place_ref_structure import PlaceRefStructure
from ojp.service_arrival_structure import ServiceArrivalStructure
from ojp.service_departure_structure import ServiceDepartureStructure
...
class ProvisionedCallAtPlaceStructure:
    ...
    :ivar expected_departure_capacities: The Capacity structure also
        ...
        mainly show elements that are important for accessibility.
    """
