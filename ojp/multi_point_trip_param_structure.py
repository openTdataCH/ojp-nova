...
class MultiPointTripParamStructure:
    ...
    :ivar multi_point_type: If a solution for any one of multiple
        origin/destination points is sufficient. Or a distinct solution
        for each of the origin/destination points has to be found.
    ...
    :ivar include_operating_days: Whether the result should include
        ...
        language.
    :ivar include_legs: Whether the result should include leg
    ...
    include_legs: Optional[bool] = field(
        default=None,
        metadata={
            "name": "IncludeLegs",
            "type": "Element",
