...
from test_create_ojp2_request import test_create_ojp2_trip_request_simple_3
from map_ojp2_to_ojp2 import map_ojp2_trip_result_to_ojp2_fare_request, parse_ojp2
...
if __name__ == '__main__':
    ...
    for i in range(600):
        try:
            ojp_trip_request = test_create_ojp2_trip_request_simple_3()
            ...
            print(r.text)
            sleep(1)
            ojp_trip_result = parse_ojp2(r.text)
