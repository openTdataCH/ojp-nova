...
class FahrplanVerbindungsHaltestelle:
    """Die Verbindungshaltestelle ist ein Halt innerhalb eines
    Verbindungssegments zu einer bestimmten Zeit an einem bestimmten Ort. Eine
    Verbindungshaltestelle definiert die Ankunfts- und Abfahrtszeit einer
    Verbindung an einer bestimmten angefahrenen Haltestelle.
    Mitternachtsüberschreitungen: Eine Mitternachtsüberschreitung liegt für ein
    VerbindungsSegment dann vor, wenn das Segment am Tag n startet und am Tag n
    + 1 endet. Eine Mitternachtsüberschreitung kann stattfinden:
