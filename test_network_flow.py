...
import xml_logger
from configuration import NOVA_URL_API, OJP_URL_API,OJP_TOKEN, NOVA_URL_TOKEN, NOVA_CLIENT_ID, NOVA_CLIENT_SECRET, READFILE, READTRIPREQUESTFILE
...
NOVA_URL_API = NOVA_URL_API + "/novaan/vertrieb/public/v14/PreisauskunftService"
