    ...
    for rf in READFILE:
        ...
        try:
            ...
            if  is_version_2_0(ojp_trip_request_xml):
                ...
                log('generated/ojp_trip_reply.xml', ojp_trip_result_xml1)
                ...
                log('generated/ojp_fare_request.xml', ojp_fare_request_xml1)
                ...
                if nova_response1:
                    ...
                    for fr in ojp_fare_result1.fare_result:
                        for fr1 in fr.trip_fare_result:
                            ...
                            print("\n")
                    log('generated/ojp_fare_result.xml', ojp_fare_result_xml1)
