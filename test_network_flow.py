...
def test_nova_request_reply(ojp: Ojp)->Optional[PreisAuskunftServicePortTypeSoapv14ErstellePreisAuskunftOutput]:
    ...
    if nova_response:
        xml_logger.log_object_as_xml('generated/nova_response.xml',nova_response)
...
if __name__ == '__main__':
    ...
    for rf in READFILE:
        if (not READTRIPREQUESTFILE):
            ...
            inputfile.close()
        xml_logger.log_serialized('generated/ojp_trip_request.xml', ojp_trip_request_xml)
        try:
            print (f"\n********************************************\n{rf}\n********************************************\n")
            if  is_version_2_0(ojp_trip_request_xml):
                ...
                xml_logger.log_serialized('generated/ojp_trip_reply.xml', ojp_trip_result_xml)
                ...
                xml_logger.log_serialized('generated/ojp_fare_request.xml', ojp_fare_request_xml)
                ...
                if nova_response:
                    ...
                    if not(ojp_fare_result):
                        ...
                        xml_logger.log_serialized('generated/ojp_fare_result.xml', ojp_fare_result_xml)
                    else:
                ...
                xml_logger.log_serialized('generated/ojp_trip_reply.xml', ojp_trip_result_xml1)
                ...
                xml_logger.log_serialized('generated/ojp_fare_request.xml', ojp_fare_request_xml1)
                ...
                if nova_response1:
                    ...
                    for fr in ojp_fare_result1.fare_result:
                        for fr1 in fr.trip_fare_result:
                            ...
                            print("\n")
                    xml_logger.log_serialized('generated/ojp_fare_result.xml', ojp_fare_result_xml1)
            ...
            logger.exception(e)
            xml_logger.log_serialized('generated/error_file.xml', str(e))
            traceback.print_exc()
