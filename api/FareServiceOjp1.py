...
from ojp import OjpfareDelivery, Ojpresponse, ServiceDelivery
from ojp2 import Ojp, ParticipantRefStructure
...
def _create_response(ojp_fare_delivery: OjpfareDelivery) -> Response:
    xml = FareServiceOjp1.serializer.render(
        Ojp(
