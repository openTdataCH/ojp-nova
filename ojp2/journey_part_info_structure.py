...
class JourneyPartInfoStructure:
    ...
    :ivar journey_part_ref: Reference to a JOURNEY part. (since SIRI
        2.0)
    :ivar train_number_ref: Train Number for JOURNEY PART (since SIRI
        2.0)
    :ivar operator_ref: OPERATOR of JOURNEY PART. (since SIRI 2.0)
