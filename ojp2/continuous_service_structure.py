...
class ContinuousServiceStructure:
    ...
    :ivar alternative_mode_of_operation: Alternative transport options.
    :ivar personal_mode_of_operation: Personal transport options.
    ...
    :ivar personal_mode: PERSONAL MODE used either for PERSONAL MODE OF
        OPERATION or in ALTERNATIVE MODE OF OPERATION.
    :ivar alternative_service: Shared mobility offer.
    ...
    alternative_mode_of_operation: Optional[
        AlternativeModesOfOperationEnumeration
    ] = field(
        default=None,
        metadata={
    ...
    personal_mode_of_operation: Optional[
        PersonalModesOfOperationEnumeration
    ] = field(
        default=None,
        metadata={
    ...
    alternative_service: Optional[AlternativeServiceStructure] = field(
        default=None,
        metadata={
