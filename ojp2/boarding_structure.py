...
class BoardingStructure:
    ...
    :ivar arrival_boarding_activity: Type of alighting allowed at stop.
        Default is 'Alighting'.
    :ivar departure_boarding_activity: Type of boarding allowed at stop.
        Default is 'Boarding'.
    """

    arrival_boarding_activity: Optional[ArrivalBoardingActivityEnumeration] = (
        field(
            default=None,
            metadata={
    ...
    departure_boarding_activity: Optional[
        DepartureBoardingActivityEnumeration
    ] = field(
        default=None,
        metadata={
