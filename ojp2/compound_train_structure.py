...
class CompoundTrainStructure:
    ...
    :ivar compound_train_code: Identifier for COMPOUND TRAIN.
    ...
    :ivar trains_in_compound_train: Ordered collection of TRAINs making
        up the COMPOUND TRAIN.
    """
    ...
    maximum_passenger_capacities: Optional[
        "CompoundTrainStructure.MaximumPassengerCapacities"
    ] = field(
        default=None,
        metadata={
    ...
    trains_in_compound_train: Optional[
        "CompoundTrainStructure.TrainsInCompoundTrain"
    ] = field(
        default=None,
        metadata={
